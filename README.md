...
[![CI](https://github.com/ryanwclark/ansible-role-pip/workflows/CI/badge.svg?event=push)](https://github.com/ryanwclark/ansible-role-pip/actions?query=workflow%3ACI)

An Ansible Role that installs [Pip](https://pip.pypa.io) on Linux.

## Requirements

On RedHat/CentOS, you may need to have EPEL installed before running this role. You can use the `ryanwclark.repo-epel` role if you need a simple way to ensure it's installed.
